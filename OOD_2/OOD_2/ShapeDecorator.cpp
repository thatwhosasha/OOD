    ...
    vector<unique_ptr<IShape>>& shapes)
{
    ...
    while (getline(input, str))
    {
        ...
        if (shape == "CIRCLE")
        {
            ...
            circles.push_back(CircleCreator.CreateShape(x, y, radius));
            shapes.push_back(CircleCreator.CreateShape(x, y, radius));
        }
        else if (shape == "RECTANGLE")
        {
            ...
            rectangles.push_back(RectangleCreator.CreateShape(x1, y1, x2, y2));
            shapes.push_back(RectangleCreator.CreateShape(x1, y1, x2, y2));
        }
        else if (shape == "TRIANGLE")
        {
            ...
            triangles.push_back(TriangleCreator.CreateShape(x1, y1, x2, y2, x3, y3));
            shapes.push_back(TriangleCreator.CreateShape(x1, y1, x2, y2, x3, y3));
        }
    }
}
